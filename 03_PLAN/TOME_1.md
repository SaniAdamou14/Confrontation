...
**Le titre.** Si l'arbitrage §6 est retenu, « vingt-deux minutes » ne désigne pas la durée d'un combat mais **le temps qu'il a fallu à Son Goku pour comprendre où il était tombé**.

---

## Vue d'ensemble

| Ch. | Jour | Focalisation | Lieu | Ce qui se passe |
|---|---|---|---|---|
...
| 17 | J17 | **Un habitant / un soldat** | L'agglomération | **Ozaru.** |
| 18 | J17-18 | **Cecil** | QG | Le bilan. La vidéo. |
...
### Ch. 1 — Les sept secondes
**Focalisation : Conquest. 16 h 28 → ~17 h 04.**

Dossier préparatoire complet : `05_ATELIER/CH01_DOSSIER_PREPARATOIRE.md`.

**Ce que le chapitre doit accomplir :**
- Installer Conquest comme un homme qui cherche à perdre — pour que son sourire à la seconde 2 soit lisible.
- Montrer Mark tenir onze minutes, sans jamais le commenter.
- Faire vivre les sept secondes de l'intérieur du seul témoin qui ne comprend rien.
- Installer le régime de puissance sans un seul chiffre.
- Planter F5 (la queue), F7 (l'armure fissurée), F10 (le scouteur), F13 (le rapport).

**Ce qu'il ne doit pas faire :** expliquer d'où viennent les Saiyans. Le lecteur qui connaît DBZ sait ; celui qui ne sait pas apprendra au chapitre 4.

**Image de fin :** la question sans réponse de Conquest. Pas un bilan.

### Ch. 2 — Vingt-deux minutes
**Focalisation : Ray Dombrowski. 16 h 47 → 17 h 09, puis le vol de retour.**
...
**Contrainte :** ce chapitre ne contient aucun mot que Ray ne connaîtrait pas. Ni « ki », ni « saiyan », ni « viltrumite », ni le nom d'aucun des deux arrivants.

### Ch. 3 — Le premier chiffre
**Focalisation : Cecil. J1-J2.**

- Il arrive sur le cratère. Vapeur, si le lac est retenu — on ne voit rien, et le chiffre se construit à l'aveugle.
- **Application de R1 :** il ne dit jamais « nous ne pouvons pas les vaincre ». Il demande un budget d'évacuation, commande un rapport, change de sujet. Le lecteur comprend seul.
...
- Le mémorandum, trois lignes (F11).
- **Le congélateur** (F1). Sang, fragments d'armure, cheveux. Le plus gros fusil du récit se charge ici, en une demi-page, sans emphase.
- Sinclair. Les Mauler sous contrat.
...
## Détail — second bloc, en une ligne chacun
...
| 11 | **✔ ÉCRIT.** Focalisation Debbie, banlieue nord de Chicago. Végéta vient corriger Kakarotte et retire une par une les raisons qu'il a de rester ici. **Goku ne rend pas un coup : il se place.** Tout est vu par un soupirail de cave. Le mot entre dans la langue. Dossier : `05_ATELIER/CH11_DOSSIER_PREPARATOIRE.md`. *(L'entraînement au-dessus du Pacifique est **reporté et non supprimé** — une démonstration sans adversaire n'est pas de l'action, mais le décor est bon et il resservira dès qu'un ordre coûtera quelque chose à tenir. Réservé, non dépensé : voir `00_CANON/CARTE_ET_LIEUX.md`.)* |
| 12 | **✔ ÉCRIT.** Focalisation Cecil, QG, J12 (dimanche 13 octobre). Le bilan chiffré du J11 tombe ici — **~9 400, fourchette 6 800-13 500**, inférieur au J0, inférieur au J17. OMEGA cesse d'être un mémorandum : ligne un devient un poste budgétaire (Abbadie, sans le savoir), ligne deux fait de Ferguson un poste permanent (sans le savoir non plus), ligne trois reste sans budget et sans nom. Le congélateur s'ouvre en accès dérogatoire partiel (F1), contre une priorité informelle laissée à Sinclair, jamais nommée comme un accord (F40). Le secteur nord est classé « en maintien ». Ferguson est convoqué par liaison et pose la question qu'il ose ; Cecil répond à côté — il n'apprend rien du J11. **Les auditions glissent au 16 octobre (J15), hors champ.** Fin sur une signature interrompue. Chapitre : `04_CHAPITRES/T1/CH12_la-deuxieme-cle.md`. Dossier : `05_ATELIER/CH12_DOSSIER_PREPARATOIRE.md`. |
...
| 18 | Le bilan. La vidéo. Le monde a vu. **Irréversible.** |
| 19 | Goku sonne à une porte. Il vient demander des vêtements à la mère du garçon qu'il a tué. |
| 20 | Elle les lui donne. **Elle sait exactement ce qu'elle fait, et elle s'en veut.** Amber a raison, et Amber a tort. Une porte se referme. |
...
- **Chicago doit rester visible dans chaque bloc de trois chapitres** — un budget, un titre, une file d'attente, une phrase de trop.
- **Aucun personnage ne suggère un destin.** S'il le fait, le récit lui donne tort.
- **Fin de tome sur une porte qui se referme.** Pas un mot après.
